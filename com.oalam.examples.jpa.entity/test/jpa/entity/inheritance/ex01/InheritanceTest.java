...
public class InheritanceTest extends AbstractPersistentTest {
    ...
    public void createItems() throws Exception {
        ...
        Item01 item01 = new Item01("Junk", 52.50f, "A piece of junk");
        CD01 cd01 = new CD01("St Pepper", 12.80f, "Beatles master piece", "Apple", 1, 53.32f, "Pop/Rock");
        CD01 cd02 = new CD01("Love SUpreme", 20f, "John Coltrane love moment", "Blue Note", 2, 87.45f, "Jazz");
        Book01 book01 = new Book01("H2G2", 21f, "Best IT book", "123-456-789", "Pinguin", 321, false);
        Book01 book02 = new Book01("The Robots of Dawn", 37.5f, "Robots, again and again", "0-553-29949-2 ", "Foundation", 264, true);
        tx.begin();
        em.persist(item01);
        em.persist(cd01);
        em.persist(cd02);
