...
/**
 * This servlet counts the times it has been accessed, the number of instances
 * created by the server, and the total times all of them have been accessed.
 * 
 * @author bailett
 */
public class S2_HolisticCounterServlet extends HttpServlet {
