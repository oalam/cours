 ...
 * @author formation
 */
@WebServlet(name = "SendMessgaeServlet", urlPatterns = {"/SendMessgaeServlet"})
public class SendMessgaeServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            try {
                sendJMSMessageToMyQueue("from servlet ?");
                out.println("sending msg");
                System.out.println("sending msg");
                /* TODO output your page here
                out.println("<html>");
                out.println("<head>");
                out.println("<title>Servlet SendMessgaeServlet</title>");  
                out.println("</head>");
                out.println("<body>");
                out.println("<h1>Servlet SendMessgaeServlet at " + request.getContextPath () + "</h1>");
                out.println("</body>");
                out.println("</html>");
                 */
            } catch (JMSException ex) {
                Logger.getLogger(SendMessgaeServlet.class.getName()).log(Level.SEVERE, null, ex);
            }
        } finally {            
            out.close();
        }
