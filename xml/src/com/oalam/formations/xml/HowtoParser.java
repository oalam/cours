 ...
 * @author bailett
 */
public class HowtoParser implements ContentHandler {
    private HowtoHandler handler;
     ...
     */
    public HowtoParser(final HowtoHandler handler, final EntityResolver resolver) {
    ...
    public final void startElement(java.lang.String ns, java.lang.String name, java.lang.String qname, org.xml.sax.Attributes attrs) throws org.xml.sax.SAXException {
        ...
        if ("topic".equals(qname)) {
            handler.start_topic(attrs);
        } else if ("howto".equals(qname)) {
            handler.start_howto(attrs);
        }
    }
    ...
    private void dispatch(final boolean fireOnlyIfMixed) throws SAXException {
        ...
        if ("title".equals(here)) {
            ...
            handler.handle_url(buffer.length() == 0 ? null : buffer.toString(), attrs);
        } else {
            //do not care
        }
     ...
     * @throws javax.xml.parsers.FactoryConfigurationRrror if the implementation cannot be instantiated
     */
    public static void parse(final org.xml.sax.InputSource input, final HowtoHandler handler) throws SAXException, ParserConfigurationException, IOException {
        parse(input, new HowtoParser(handler, null));
    }
     ...
     * @throws javax.xml.parsers.FactoryConfigurationRrror if the implementation cannot be instantiated
     */
    public static void parse(final java.net.URL url, final HowtoHandler handler) throws SAXException, ParserConfigurationException, IOException {
        parse(new org.xml.sax.InputSource(url.toExternalForm()), handler);
    }

    private static void parse(final org.xml.sax.InputSource input, final HowtoParser recognizer) throws SAXException, ParserConfigurationException, IOException {
