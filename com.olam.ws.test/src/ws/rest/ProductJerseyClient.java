...
/** Jersey REST client generated for REST resource:ProductFacadeREST [rest.product]<br>
 *  USAGE:<pre>
...
public class ProductJerseyClient {
    ...
    private static final String BASE_URI = "http://localhost:8080/com.oalam.ws/resources";

    public ProductJerseyClient() {
	com.sun.jersey.api.client.config.ClientConfig config = new com.sun.jersey.api.client.config.DefaultClientConfig();
	client = Client.create(config);
	webResource = client.resource(BASE_URI).path("rest.product");
    }
